...
class SaleController extends Controller
{
   public function getSaleNotes()
   {
      ...
      return view('saleNotes', ['saleNotes' => $saleNotes, 'customers' => $customers]);
   }
   ...
   public function addSaleNote(Request $request)
   {
      $this->validate($request, [
         ...
         'sale_date' => 'required|date_format:Y-m-d|max:100'
      ]);
   ...
   public function addSaleGet($sale_note_id)
   {
      ...
      return view('addSaleGet', ['sales' => $sales,'sale_note_id' => $sale_note_id, 'customer_name' => $customer_name, 'items_type' => $items_type, 'items' => $items]);
   }
   ...
   public function printSale($sale_note_id)
   {
      $customer_name = SaleNote::find($sale_note_id)->customer_name;
      $sales = Sale::where('sale_note_id', $sale_note_id)->get();
      return view('printSale', ['customer_name' => $customer_name, 'sales' => $sales]);
   }
}
